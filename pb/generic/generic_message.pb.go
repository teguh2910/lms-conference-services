...
const file_generic_generic_message_proto_rawDesc = "" +
	"\n" +
	"\x1dgeneric/generic_message.proto\x12\x17lms_conference_services\"\x0e\n" +
	"\fEmptyMessage\"\x14\n" +
	"\x02Id\x12\x0e\n" +
	...
	"\x04sort\x18\x05 \x01(\tR\x04sortB+Z)lms-conference-service/pb/generic;genericb\x06proto3"
...
var file_generic_generic_message_proto_goTypes = []any{
	(*EmptyMessage)(nil),  // 0: lms_conference_services.EmptyMessage
	(*Id)(nil),            // 1: lms_conference_services.Id
	(*StringMessage)(nil), // 2: lms_conference_services.StringMessage
	(*BoolMessage)(nil),   // 3: lms_conference_services.BoolMessage
	(*Pagination)(nil),    // 4: lms_conference_services.Pagination
}
